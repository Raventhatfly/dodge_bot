...
namespace shoot_controller {
    ...
    ShootController::command_interface_configuration() const{
        ...
        command_interfaces_config.names.push_back("fric_wheel_left_joint/" + std::string(HW_IF_EFFORT));
        command_interfaces_config.names.push_back("fric_wheel_right_joint/" + std::string(HW_IF_EFFORT));
        command_interfaces_config.names.push_back( "loader_joint/" + std::string(HW_IF_EFFORT));
    ...
    controller_interface::InterfaceConfiguration 
        ...
        state_interfaces_config.names.push_back("fric_wheel_left_joint/" + std::string(HW_IF_VELOCITY));
        state_interfaces_config.names.push_back("fric_wheel_right_joint/" + std::string(HW_IF_VELOCITY));
        state_interfaces_config.names.push_back("loader_joint/" + std::string(HW_IF_VELOCITY));
